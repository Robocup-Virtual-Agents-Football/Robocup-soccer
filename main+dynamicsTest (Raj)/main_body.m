...
%    [force_new, vel_ball_new, ball_position_new, ballStopped] = BallDynamicsTest2(force, vel_ball, ball_position, ballStopped);
...
%     ballStopped
    [vel_new, pos_new] = BallDynamicsTest3(vel_ball(timeStep, :), ball_position(timeStep, :))
    vel_ball(timeStep+1, :) = vel_new;
    ball_position(timeStep+1, :) = pos_new;
...
%% Draw Field
    ...
    ShowField(ball_position(end, :), robot_position, headingAngle); 
